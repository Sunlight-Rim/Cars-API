...
func easyjson3c9d2b01DecodeCarsInternalAdaptersPrimaryRestRequest1(in *jlexer.Lexer, out *SignoutAll) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3c9d2b01EncodeCarsInternalAdaptersPrimaryRestRequest1(out *jwriter.Writer, in SignoutAll) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson3c9d2b01DecodeCarsInternalAdaptersPrimaryRestRequest2(in *jlexer.Lexer, out *Signout) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3c9d2b01EncodeCarsInternalAdaptersPrimaryRestRequest2(out *jwriter.Writer, in Signout) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson3c9d2b01DecodeCarsInternalAdaptersPrimaryRestRequest3(in *jlexer.Lexer, out *Signin) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3c9d2b01EncodeCarsInternalAdaptersPrimaryRestRequest3(out *jwriter.Writer, in Signin) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson3c9d2b01DecodeCarsInternalAdaptersPrimaryRestRequest4(in *jlexer.Lexer, out *Refresh) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3c9d2b01EncodeCarsInternalAdaptersPrimaryRestRequest4(out *jwriter.Writer, in Refresh) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson3c9d2b01DecodeCarsInternalAdaptersPrimaryRestRequest5(in *jlexer.Lexer, out *GetMe) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3c9d2b01EncodeCarsInternalAdaptersPrimaryRestRequest5(out *jwriter.Writer, in GetMe) {
	out.RawByte('{')
	first := true
	_ = first
	out.RawByte('}')
...
func easyjson3c9d2b01DecodeCarsInternalAdaptersPrimaryRestRequest6(in *jlexer.Lexer, out *GetCars) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3c9d2b01EncodeCarsInternalAdaptersPrimaryRestRequest6(out *jwriter.Writer, in GetCars) {
	out.RawByte('{')
	first := true
	_ = first
	out.RawByte('}')
...
func easyjson3c9d2b01DecodeCarsInternalAdaptersPrimaryRestRequest7(in *jlexer.Lexer, out *CreateCar) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3c9d2b01EncodeCarsInternalAdaptersPrimaryRestRequest7(out *jwriter.Writer, in CreateCar) {
	out.RawByte('{')
	first := true
	_ = first
	{
